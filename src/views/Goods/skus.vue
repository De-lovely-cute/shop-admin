...
import SkuCard from "@/views/Goods/SkuCard.vue";
import SkuTable from "@/views/Goods/SkuTable.vue";

import { readGoods, updateGoodsSkus } from "@/api/goods";
import { notifc } from "@/componsables/util";

import { goodsId, initSkuCardList, sku_list } from "@/componsables/useSku";
