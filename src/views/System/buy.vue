...
import { getToken } from "@/componsables/auth";
...
<template>
  <div v-loading="loading" class="bg-white p-4 rounded">
    <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
      <el-tab-pane label="支付设置" name="first">
        <el-table :data="tableData" border stripe>
          ...
          <el-table-column label="配置" align="center" width="150">
            <template #default="{ row }">
              <el-button type="primary" text size="small" @click="open(row.key)"
                >配置</el-button
              >
            </template>
          </el-table-column>
    ...
    <FormDrawer ref="formDrawerRef" title="配置" @submit="onSubmit">
